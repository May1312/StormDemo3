...
public class HttpClientUtils {
	 ...
	 * @throws IOException
	 */
	public static String simplePostInvoke(String url, Map<String, Object> params)
			throws URISyntaxException, ClientProtocolException, IOException {
		return simplePostInvoke(url, params,CONTENT_CHARSET);
	}
	public static String simplePostInvoke2(String url, Map<String, Object> params)
			throws URISyntaxException, ClientProtocolException, IOException {
		return simplePostInvoke(url, params,CONTENT_CHARSET);
	}
	/**
	 ...
	 * @throws IOException
	 */
	public static String simplePostInvoke(String url, Map<String, Object> params,String charset)
			throws URISyntaxException, ClientProtocolException, IOException {
